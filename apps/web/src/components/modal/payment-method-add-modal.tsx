...
import { PaymentMethodAddForm, StripeProvider } from '@/components';
  ...
  return (
    <>
      ...
      <PaymentMethodAddForm
        onLoad={() => {
          setForm((form) => ({ ...form, loaded: true }));
        }}
        onLoading={(loading) => {
          setForm((form) => ({ ...form, loading }));
        }}
        onComplete={(completed) => {
          setForm((form) => ({ ...form, completed }));
        }}
      ...
      >
        <DialogFooter>
          ...
          <Button
            type="submit"
            variant="default"
            disabled={form.loading || !form.loaded || !form.completed}
