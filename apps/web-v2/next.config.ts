      ...
      },
      {
        ...
        headers: [
          ...
          ...(isDev ? [] : [{
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://js.stripe.com https://api.mapbox.com https://www.google.com https://www.gstatic.com https://us-assets.i.posthog.com https://static.cloudflareinsights.com https://connect.facebook.net https://accounts.google.com/gsi/client",
