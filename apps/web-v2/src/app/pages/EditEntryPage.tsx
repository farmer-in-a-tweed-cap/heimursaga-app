...
export function EditEntryPage() {
  ...
  const buildSavePayload = useCallback(() => {
    return {
      ...
      ...(entryType === 'data' ? { metadata: {
        ...(dlTemperature ? { temperature: parseFloat(dlTemperature) } : {}),
        ...(dlHumidity ? { humidity: parseFloat(dlHumidity) } : {}),
        ...(dlWindSpeed ? { windSpeed: parseFloat(dlWindSpeed) } : {}),
        ...(dlPressure ? { pressure: parseFloat(dlPressure) } : {}),
        ...(dlDistanceCovered ? { distanceCovered: parseFloat(dlDistanceCovered) } : {}),
  ...
  if (loadError) {
    return (
      <div className="max-w-[1600px] mx-auto px-6 py-12">
        <div className="bg-white dark:bg-[#202020] border-2 border-[#202020] dark:border-[#616161]">
          <div className="p-6 border-b-2 border-[#202020] dark:border-[#616161] bg-[#994040] text-white">
            <div className="flex items-center gap-3">
...
• Any relevant background or conditions`}
              ...
              {/* Submit Error */}
              {submitError && (
                <div className="p-4 bg-red-50 dark:bg-red-900/20 border-2 border-[#994040] text-red-700 dark:text-red-400 text-sm">
