    ...
    <div className="border-2 border-[#202020] dark:border-[#616161] bg-white dark:bg-[#202020] flex flex-col md:flex-row hover:border-[#ac6d46] transition-all active:scale-[0.99]">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="px-4 py-3 flex-1 border-b border-[#202020] dark:border-[#616161]">
          <p className="font-serif text-sm dark:text-[#e5e5e5]" style={{ lineHeight: 1.75 }}>{excerpt}</p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between px-4 py-3 bg-[#f5f5f5] dark:bg-[#2a2a2a] gap-3">
          ...
          <div className="flex gap-2">
            <Link
              href={`/entry/${id}`}
              className="flex items-center gap-2 px-4 py-2 bg-[#ac6d46] text-white hover:bg-[#8a5738] transition-all active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none focus-visible:ring-[#ac6d46] text-xs font-bold whitespace-nowrap"
            >
